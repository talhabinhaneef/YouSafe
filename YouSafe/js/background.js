(() => {
    ...
    function o(o, s = null, r = []) {
        e.get(s, (n => {
            t.runtime.lastError ? (e = t.storage.local, e.get(s, (e => {
                o(e, ...r)
            }))) : o(n, ...r)
        }))
    }
    ...
    const r = ("object" == typeof browser && "object" == typeof browser.runtime && (t = browser), e = t.storage.local, "object" == typeof t.storage.sync && (e = t.storage.sync), t),
        n = {
            hide_feed: !0,
    ...
    r.runtime.onInstalled.addListener((({
        ...
        "install" === e && r.tabs.create({
            url: "https://yousafe.programerhub.com"
        })
    })), r.runtime.setUninstallURL("https://yousafe.programerhub.com");
    let c = {
        hide_feed: !1,
        hide_redirect_home: !1,
        hide_trending: !1,
    ...
    o((function (o) {
        ...
        })), s(n)), i(o.yt_off || n.yt_off)
    })), a(), r.storage.onChanged.addListener((e => {
        for (let t = 0; t < d.length; t += 1)
            if (Object.prototype.hasOwnProperty.call(e, d[t])) {
                "yt_off" === d[t] && i(e.yt_off.newValue), a();
                break
            }
        ...
        c.yt_off || ((c.hide_trending && /^https:\/\/.*\.youtube\.com\/feed\/(trending|explore)/.test(e) || c.hide_subs && -1 !== e.indexOf("subscriptions")) && _("https://www.youtube.com", t), c.hide_redirect_home && c.hide_feed && !c.hide_subs && /^https:\/\/.*\.youtube\.com\/(?:\?.*)?$/.test(e) && _("https://www.youtube.com/feed/subscriptions", t))
    }), {
